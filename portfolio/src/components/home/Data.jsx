...
const Data = () => {
  return (
    <div className='home__data'>
        <h1 className="home__title">Ahmad Mujtaba
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        🔍 As you explore my projects, you'll discover a tapestry woven with meticulous code, creativity, and a relentless pursuit of excellence.
        </p>
